...
def define_mass_properties():
    ...
    wing.quantities.mass_properties = nasa_lpc_weights.compute_wing_mps(
...
# EoM model
def evaluate_euler_6_dof_eom_model():
    num_nodes = 1
...
def test_m4_wing_mass():
    ...
    np.testing.assert_almost_equal(
        wing.quantities.mass_properties.mass.value, 
        desired_wing_mass,
        decimal=8,
    )
    ...
    # Test cg
    np.testing.assert_almost_equal(
        wing.quantities.mass_properties.cg_vector.value[0],
        desired_wing_cg[0], 
        decimal=8
    )
    ...
    # Test inertia
    np.testing.assert_almost_equal(
        wing.quantities.mass_properties.inertia_tensor.value[0, 0],
        desired_wing_it_00,
        decimal=8
    )

    np.testing.assert_almost_equal(
        wing.quantities.mass_properties.inertia_tensor.value[1, 1],
        desired_wing_it_11,
        decimal=8
    )

    np.testing.assert_almost_equal(
        wing.quantities.mass_properties.inertia_tensor.value[2, 2],
        desired_wing_it_22,
        decimal=8
    )

def test_euler_6_dof():
    ...
    accelerations = evaluate_euler_6_dof_eom_model()
...
def test_condition_parameterization():
